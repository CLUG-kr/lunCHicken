package com.example.seolhee.imagetest.gettetheredip;
    ...
    public ArrayList<ClientScanResult> getClientList(boolean onlyReachables, int reachableTimeout) {
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                Log.d("getClientList", splitted.toString());
                if ((splitted != null) && (splitted.length >= 4)) {
                    ...
                    if (mac.matches("..:..:..:..:..:..")) {
                        ...
                        if (!onlyReachables || isReachable) {
                            ...
                            if(!clientScanResult.getDevice().equals("wlan0"))
            ...
            Log.d("getClientList", "Exception ERROR");
            e.printStackTrace();
